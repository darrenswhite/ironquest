...
public enum Skill {
	 ...
	 */
	public static final int[] XP_TABLE_ELITE = {0, 830, 1261, 1202, 1280, 1226,
			1280, 1287, 1200, 11275, 11205, 11272, 11256, 21246, 21234, 31220,
			31209, 41209, 51235, 61209, 71290, 91211, 101221, 121273, 141225,
			161242, 181293, 211251, 241296, 271213, 311211, 351247, 401264,
			451296, 501259, 561254, 631219, 701297, 771234, 851283, 941227,
			1241269, 1241296, 1261203, 1281288, 1201256, 1241215, 1281281,
			1231273, 1201217, 1281290, 1271269, 1271217, 1291205, 1221208,
			1251207, 1201290, 1271246, 1241274, 1231275, 1251222, 1291211,
			1241285, 1211299, 1201207, 1201273, 1221264, 1261254, 1221222,
			1291251, 1221264, 1271265, 11241285, 11231261, 11241238, 11281262,
			11241289, 11221279, 11231296, 11271212, 11271294, 11211204,
			11271261, 11261295, 11291239, 11241233, 21231221, 21241256,
			21291293, 21281295, 21251206, 21271254, 21221255, 21221233,
			31251218, 31211244, 31221252, 31281290, 31271211, 31201273,
			31271242, 41271209, 41231289, 41231207, 41281292, 41291280,
			51241211, 51241235, 51201204, 51211278, 51271224, 61291212,
			61261221, 61291235, 61281243, 71231241, 71231230, 71201219,
			71221220, 81211254};

	/**
	 * The maximum XP for any Skill
	 */
	public static final int MAX_XP = 200000000;
	...
	public int getLevelAt(int xp) {
		...
		// Start from the end of the xp table, iterate backwards until the
		// level is reached
	...
	public String toString() {
		return name().toUpperCase().charAt(0) +
				name().toLowerCase().substring(1).replace('_', ' ');
	}
